            ...
            <article className="max-w-4xl mx-auto">
                ...
                <div className="space-y-6">
                    ...
                    <section>
                        ...
                        <p className="leading-relaxed">Futurama is an American animated science fiction sitcom created by Matt Groening for the Fox Broadcasting Company and later revived by Comedy Central, and then Hulu. The series follows Philip J. Fry, a young man who is cryogenically preserved for 1,000 years and revived on December 31, 2999.</p>
                        <p>Fry finds work at the interplanetary delivery company Planet Express, working alongside the one-eyed mutant Leela and the robot Bender. </p>
                    </section>
